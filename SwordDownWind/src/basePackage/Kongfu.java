...
public class Kongfu extends JFrame{
	...
	public Kongfu(Hero player) {
		...
		MyDialog.showMessageDialog("             如今，你学艺已成，只愿你下山之后，行侠仗义，秉承这天\n    地正气而行！","卧龙子", LenthAll.TALK_DIALOG_WIDTH, LenthAll.TALK_DIALOG_HEIGHT);
		MyDialog.showMessageDialog("                  是，师傅，弟子定当不辱师门！","燕惊寒", LenthAll.TALK_DIALOG_WIDTH, LenthAll.TALK_DIALOG_HEIGHT);
